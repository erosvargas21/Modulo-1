...
class Module:
    ...
    def named_parameters(self):
        ...
        for child_name in self._modules.keys():
            child_params = self._modules[child_name].named_parameters()
            names = [child_name+'.'+ name for name in child_params.keys()]
            child_params= dict(zip(names,child_params.values()))
            res = {**res, **child_params}
        return res
